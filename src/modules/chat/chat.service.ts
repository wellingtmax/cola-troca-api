  ...
  return this.alertService.success(
    ...
    async createMessage(
        ...
        /*
          ...
          Se a mensagem for resposta de outra mensagem,
          e a mensagem respondida for de outro usuário,
          cria notificação para o dono da mensagem original.
        */
        ...
        /*
          ...
          Se o conteúdo tiver @nickname ou C&T#0003,
    ...
    async toggleLike(
        ...
        const existingLike = await this.prisma.chatMessageLike.findUnique({
            where: {
                userId_messageId: {
                    userId,
                    messageId,
